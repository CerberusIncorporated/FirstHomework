package by.yukhnevich.xmltask.handler;

import by.yukhnevich.xmltask.builder.GemsXmlTag;
import by.yukhnevich.xmltask.entity.*;
import by.yukhnevich.xmltask.factory.GemFactory;
...
public class GemHandler extends DefaultHandler {
    ...
    public void characters(char[] ch, int start, int length) {
        ...
        switch (currentXmlTag) {
            ...
            case FACETS -> {
                currentGem.setFacets(Integer.parseInt(data));
            }
            case MASS -> {
