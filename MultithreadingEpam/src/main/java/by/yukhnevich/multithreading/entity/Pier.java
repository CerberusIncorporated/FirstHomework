...
import by.yukhnevich.multithreading.util.PierIdGenerator;
...
public class Pier {
    ...
    public void processShip(Ship ship) {
        logger.info("Pier {} starts processing ship {}", pierId, ship.getShipId());
        try {
        ...
        logger.info("Pier {} ends processing ship {}", pierId, ship.getShipId());
    }
